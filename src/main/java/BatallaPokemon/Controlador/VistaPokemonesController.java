...
import BatallaPokemon.Controlador.Nodos.PokemonButtonController;
...
import static BatallaPokemon.Controlador.VistaCampoController.getColor;
...
public class VistaPokemonesController {
    ...
    public void llenarLista(List<Pokemon> pokemones, Pokemon pokemonActual) {
        String path = "/Vista/PokemonButton.fxml";
        int opcion = 0;
        try {
